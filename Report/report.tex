...
\fancypagestyle{plain}{%
  \fancyhf{}
  \fancyfoot[CE]{Pune Institute of Computer Technology, Department of Computer Engineering 2016-2017}
  \fancyfoot[RE]{\thepage}
}
\pagestyle{fancy}
\fancyhead{}
...
{\bfseries \fontsize{16}{12} \selectfont MACHINE LEARNING FOR CLASSIFICATION OF ABSTRACT IMAGES \\ \vspace*{2\baselineskip}}
...
\vspace*{1\baselineskip}} 
\centerline{Animesh Karnewar  \hspace{25 mm} Exam No: B120054328}
\centerline{Chinmay Sawant \hspace{25 mm} Exam No: **B120054328}
\centerline{Ameeth Kanawaday \hspace{25 mm} Exam No: **B120054328}
\centerline{Yash Gupta \hspace{25 mm} Exam No: **B120054328}
\vspace*{1\baselineskip}
{\bfseries \fontsize{14}{12} \selectfont Under The Guidance of \\  
\vspace*{0.4\baselineskip}} 
Internal Guide: Prof. D. T. MANE\\
External Guide: Dr. Parag Kulkarni\\
\includegraphics[width=100pt]{Images/collegelogo.jpg} \\
...
{\bfseries \fontsize{14}{12} \selectfont \centerline{MACHINE LEARNING FOR CLASSIFICATION OF ABSTRACT IMAGES}
\vspace*{1\baselineskip}}
...
\centerline{Yash Gupta \hspace{25 mm} Exam No: **B120054328}
\vspace*{1\baselineskip} 
is a bonafide work carried out by Students under the supervision of Prof. D. T. Mane and it
...
\begin{tabular}{c c }
Prof. D. T. Mane &  \hspace{50 mm} Prof. R. B. Ingale \\								
...
\setcounter{page}{0}
\frontmatter
\cfoot{PICT, Department of Computer Engineering 2016-2017}
\rfoot{\thepage}
\pagenumbering{Roman}
...
\begin{center}
	\begin{figure}[!htbp]
		\centering
		\fbox{\includegraphics[width=\textwidth]{Images/use-case.jpg}}
...
\begin{center}
	\begin{figure}[!htbp]
		\centering
		\fbox{\includegraphics[height=430pt]{Images/activity-dig.jpg}}
...
\begin{center}
	\begin{figure}[!htbp]
		\centering
		\fbox{\includegraphics[width=230pt]{Images/state-dig.jpg}}
...
\section{Architectural Design}  
  ...
  \begin{center}
	\begin{figure}[!htbp]
		\centering
		\fbox{\includegraphics[width=\textwidth]{Images/arch2.jpg}}
...
\subsection{Class Diagram}
 \begin{center}
	\begin{figure}[!htbp]
		\centering
		\fbox{\includegraphics[width=450pt]{Images/class-dig.jpg}}
