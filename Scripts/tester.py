...
with graph.as_default():
    ...
    with tf.name_scope("testing_the_saver_module"):
        name_of_some_bringer = tf.Variable("bringer_of_shit", dtype=tf.string, name="scoper")
...
with tf.Session(graph=graph) as session:
	...
	print("Name of some Bringer:", session.run(name_of_some_bringer))
